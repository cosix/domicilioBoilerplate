		...
		<div class="">
			<form name="contact" method="post" data-netlify="true" data-netlify-honeypot="bot-field">
               ...
               <label class="lock text-gray-800 ml-2 font-bold md:text-right mb-1 md:mb-0 pr-4">Email
				...
				<p class="my-5">
					<button class="block w-full bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" type="submit">Invia richiesta</button>
				</p>
			</form>
		</div>
	);
